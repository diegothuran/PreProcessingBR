...
RUN_TAGGER_CMD = "java -XX:ParallelGCThreads=2 -Xmx3024m -jar ark-tweet-nlp.jar"
...
if __name__ == "__main__":
    ...
    print runtagger_parse(['@I am here', 'I am going to the school'], run_tagger_cmd="java -XX:ParallelGCThreads=2 -Xmx500m -jar ../ark-tweet-nlp-0.3.2/ark-tweet-nlp-0.3.2.jar")
    # if success:
    #     print "Success."
