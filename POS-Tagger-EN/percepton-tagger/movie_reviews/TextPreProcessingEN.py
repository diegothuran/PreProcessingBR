...
from Util_Cython import generateSimilarityMatrix, writeTxt
from Util_Cython import termFrequency
from Util_Cython import inverseDocumentFrequency
...
def main():
    ## read corpus
    with open('corpus/unbalanced_two_classes.pkl', 'rb') as input:
